  ...
  return (
    <footer className="footer">
      <div className="footer__container container">
        <Link className="footer__logo logo" to="/"><img className="logo__img" width="70" height="70" src="./img/svg/logo.svg" alt="Логотип" /></Link>
        ...
        <section className="footer__nav-section footer__nav-section--links">
          ...
          <ul className="footer__nav-list">
            <li className="footer__nav-list-item"><Link className="link" to="/">Где купить?</Link>
            </li>
            <li className="footer__nav-list-item"><Link className="link" to="/">Блог</Link>
            </li>
            <li className="footer__nav-list-item"><Link className="link" to="/">Вопрос - ответ</Link>
            </li>
            <li className="footer__nav-list-item"><Link className="link" to="/">Возврат</Link>
            </li>
            <li className="footer__nav-list-item"><Link className="link" to="/">Сервис-центры</Link>
            </li>
          </ul>
        </section>
        <section className="footer__nav-section footer__nav-section--contacts">
          ...
          <div className="footer__nav-content">
            ...
            </svg><Link className="link" to="/"> 8-812-500-50-50</Link>
          </div>
